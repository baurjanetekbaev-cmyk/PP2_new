...
# Finding the projection of the origin onto the line segment to check for intersection
...
if closest_dist >= r:
    ...
    # Path is blocked by the circle; calculate the tangent paths and the arc length
